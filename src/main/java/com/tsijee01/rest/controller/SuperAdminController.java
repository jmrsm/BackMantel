...
public class SuperAdminController {
	...
	public ResponseEntity<List<UsuarioDTO>> obtenerusuarios(HttpServletRequest request,
		...
		//
		// Pageable pag = PageUtils.getPageRequest(start, end, sortField,
		// sortOrder);
		// if (StringUtils.isEmpty(query)){
		// Page<Usuario> pelis = usuarioService.listarUsuarios(pag);
		// }else {
		// Page<Usuario> pelis = usuarioService.buscarUsuarios(pag);
		// }
		//
		//
